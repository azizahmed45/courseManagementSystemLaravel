            ...
            <div class="card card-primary card-outline">
                <div class="card-body box-profile">
                    <div class="text-center">
                        <img class="profile-user-img img-fluid img-circle" src="{{ asset('img/teacher-profile.jpg') }}" alt="User profile picture">
                    </div>
                    ...
                    <ul class="list-group list-group-unbordered mb-3">
                        <li class="list-group-item">
                            <b>Total Courses</b> <a class="float-right">{{ $teacher->courses()->count() }}</a>
                        </li>
                        <li class="list-group-item">
