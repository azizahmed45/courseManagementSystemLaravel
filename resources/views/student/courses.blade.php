        ...
        <div class="container-fluid">
            ...
            <div class="row mb-2 mr-2">
                <div class="col-12">
                    ...
                    <a class="btn-lg btn-primary float-right" href="{{ route('student.joinCourse') }}" role="button">Join Course</a>
                </div>
            </div>
            {{--            small box start--}}
            <div class="row">
                        ...
                        <div class="card card-widget widget-user-2 shadow-sm">
                            ...
                            <div class="card-footer p-0">
                                <ul class="nav flex-column">
                                    <li class="nav-item">
                                        <a href="{{route('student.courses.students', [$course])}}" class="nav-link">
                                            Students <span
                                                class="float-right badge bg-primary">{{ $course->students->count() }}</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{route('student.courses.assignments', [$course])}}" class="nav-link">
                                            Assignments <span
